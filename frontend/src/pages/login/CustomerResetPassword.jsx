...
function CustomerResetPassword() {
  ...
  return (
    <LoginShell
      pageTitle="Customer Reset Password"
      pageDescription="Set a new password."
      notice="Choose a strong password to keep your account safe."
      leftTitle="Set a new password"
      leftDescription="Create a strong, unique password for your customer account so it stays protected and ready for your next booking."
