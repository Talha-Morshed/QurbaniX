...
function CustomerRegister() {
  ...
  const handleSubmit = (event) => {
    ...
    if (isDev) {
      ...
      console.log('[DEV PIN] Customer registration PIN for', form.phone, ':', pin);
    }
  };
  ...
  const resendPin = () => {
    ...
    if (isDev) {
      // eslint-disable-next-line no-console
      console.log('[DEV PIN] Resent customer registration PIN for', form.phone, ':', pin);
    }
  };
      ...
      {submitted ? (
        ...
        <form className="space-y-6" onSubmit={handleSubmit} noValidate>
          ...
          <p className="text-center text-sm text-slate-600">
            ...
            <Link to="/login/customer" className="font-semibold text-[#9b1455] hover:text-[#7a0f40]">
              Log In
            </Link>
          </p>
        </form>
