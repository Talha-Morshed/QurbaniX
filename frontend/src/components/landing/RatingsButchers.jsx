...
const topButchers = [
  { initials: 'RA', name: 'Rashid Ali', specialty: 'Cow & Camel Specialist', area: 'Dhanmondi, Dhaka', rating: 4.9, orders: 342 },
  { initials: 'KS', name: 'Kamran Sheikh', specialty: 'Goat & Sheep Expert', area: 'Gulshan, Dhaka', rating: 4.8, orders: 298 },
  { initials: 'IH', name: 'Imran Hossain', specialty: 'Shared Qurbani (7 Shares)', area: 'Mirpur, Dhaka', rating: 4.8, orders: 275 },
  { initials: 'AK', name: 'Abdul Karim', specialty: 'Home Slaughter Service', area: 'Uttara, Dhaka', rating: 4.7, orders: 241 },
];
...
export default function RatingsButchers() {
  return (
    <section id="ratings" className="bg-warm-cream border-t border-slate-100">
      <div className="max-w-7xl mx-auto px-6 py-16 lg:py-24">
        ...
        <div className="mt-12 grid grid-cols-1 lg:grid-cols-12 gap-6 items-start">
          <div className="lg:col-span-5 bg-white ring-1 ring-slate-200 shadow-sm p-8 flex flex-col gap-6">
            ...
            <div className="grid grid-cols-2 gap-4 pt-2 border-t border-slate-100">
              ...
              <div>
                <p className="text-2xl font-extrabold text-emerald-900">12,400+</p>
          ...
          <div className="lg:col-span-7 flex flex-col gap-4">
            ...
            {topButchers.map((butcher) => (
              ...
              >
                <div className="keep-circular w-14 h-14 shrink-0 bg-emerald-900 text-[#D4A72C] font-extrabold text-lg flex items-center justify-center">
                  {butcher.initials}
                </div>
            ...
            <p className="text-xs text-slate-400 px-1">* Demo data shown for preview purposes.</p>
          </div>
        </div>
      </div>
    </section>
